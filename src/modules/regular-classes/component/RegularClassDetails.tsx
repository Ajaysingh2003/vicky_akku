    ...
    <div className="py-3 flex w-full h-full items-center justify-center   lg:py-7">
      <div className="w-full space-y-3 md:space-y-6   m-auto px-4">
        <div className="title-place flex-wrap order-1">
          <h3 className="text-4xl wrap-break-word   md:text-left font-borscha  capitalize  text-[#4B4740]">
            {data.title} -{" "}
            <span className="text-4xl font-borscha   capitalize text-center md:text-left text-[#827B70]">
              {data?.City}
            </span>
          </h3>
        </div>
        ...
        <div className="w-full space-y-2">
          ...
          <ul className="flex flex-wrap gap-4">
            {data.perfectFor.map((e) => (
              <li
                key={e.id}
                className="border px-2 md:px-4 py-2 text-[#656565] font-semibold border-black rounded-full text-sm md:text-md"
              >
        ...
        <div className="flex w-full mx-auto max-w-[200px] md:max-w-full mt-6  items-center md:items-start flex-col md:flex-row gap-4 md:gap-6">
