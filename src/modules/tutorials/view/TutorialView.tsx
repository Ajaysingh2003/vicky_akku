      ...
      <div className="h-full  py-24">
        <div className="w-[85%] flex items-center flex-col mx-auto">
          <motion.h1  initial={{ opacity: 0, y: 60 }}
            ...
            transition={{ duration: 0.6 }} className="font-borscha font-bold text-center wrap-break-word max-w-[300px] lg:max-w-6xl  text-[#C77F90] text-4xl  lg:text-8xl uppercase">
            {data.title}
          </motion.h1>
